...
(0, _motion.inView)(".projects-section", ({ target })=>{
    (0, _motion.animate)(target.querySelectorAll(".project-card"), {
        y: [
            "-100px",
            "0"
        ],
    ...
    (0, _motion.animate)(target.querySelectorAll([
        ...
        duration: .5,
        delay: (0, _motion.stagger)(0.25, {
            start: .25
        }),
        easing: "ease-out"
    });
});
(0, _motion.inView)(".about-section", ({ target })=>{
    (0, _motion.animate)(target.querySelectorAll("img"), {
        x: [
            "-100px",
            "0"
        ],
...
(0, _motion.inView)(".header", ({ target })=>{
    (0, _motion.animate)(target.querySelectorAll([
        "h1",
        "p"
    ]), {
    ...
    (0, _motion.animate)(target.querySelector(".animated-text"), {
        x: [
            "-50px",
            "0"
        ],
...
},{"@motionone/dom":"krEZT","@motionone/utils":"krBNu","@motionone/animation":"ebY3Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hPIHA","igcvL"], "igcvL", "parcelRequire2041")
